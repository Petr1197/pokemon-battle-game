...
export default function BattleUI({
  ...
  const renderGameState = () => {
    switch (gameState.status) {
      ...
      case "player1_turn":
        return (
          <div className="battle-container font-pixelify font-bold">
            <h2>Your Turn!</h2>
            <div className="player-stats">
              <div className="player player2">
                <img
                  src={gameState.player2.sprites.front}
                  alt={gameState.player2.name}
                  width={300}
                  height={300}
                />
                <div className="stats">
                  <h3>{gameState.player2.name.toLocaleUpperCase()}</h3>
              ...
              <div className="player player1">
                <img
                  src={gameState.player1.sprites.back}
                  alt={gameState.player1.name}
                  width={300}
                  height={300}
                />
                <div className="stats">
                  <h3>{gameState.player1.name.toLocaleUpperCase()}</h3>
                  <div className="health-bar-container">
                    <p>HP</p>
                    <div className="health-bar">
                      <div
                        className={
                          gameState.player1.hp / gameState.player1.maxHp < 0.3
                            ? "health-fill-low"
                            : "health-fill"
                        }
                        style={{
